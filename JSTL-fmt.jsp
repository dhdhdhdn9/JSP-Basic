...
<body>
	<h1>JSTL-fmt</h1>
	<h2>formatNumber - 숫자를 컴마단위로 출력/형식 지정 후 출력</h2>
	...
	<h2>formatDate - 날짜 형식 지정 후 출력</h2>
	...
	<h2>parseNumber - 문자 형식을 숫자로 변환</h2>
	...
	<h2>requestEncoding - 클라이언트의 요청 처리 시 문자 인코딩 지정</h2>
	<fmt:requestEncoding value="UTF-8"/>
	
	<h2>setBundle, message - 키와 값으로 구성된 이소스 번들 파일 다루기</h2>
	<!-- 지정된 경로: src/패키지명/bundle.properties -->
	<fmt:setBundle basename="soonj.bundle"/>
